...
export default function ProfileStats({ sneakersCount, friendsCount, totalValue }: ProfileStatsProps) {
    return (
        ...
        <View>
            <Text className="font-spacemono-bold text-lg text-center">{sneakersCount}</Text>
            <Text className="font-spacemono text-base text-center">sneakers</Text>
        </View>

        <View>
            <Text className="font-spacemono-bold text-lg text-center">{friendsCount}</Text>
            <Text className="font-spacemono text-base text-center">friends</Text>
        </View>

        <View>
            <Text className="font-spacemono-bold text-lg text-center">${totalValue}</Text>
