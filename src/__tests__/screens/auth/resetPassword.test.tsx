...
import ResetPasswordPage from '@/src/app/(auth)/reset-password';

import { fillAndBlurInput } from '../../setup';
import { mockUseAuth, resetMocks } from '../../setup/auth';
...
describe('Reset Password Page', () => {
	...
	beforeEach(() => {
		...
		).mockReturnValue({ token: '1234567890' });
	...
	describe('form validation', () => {
		describe('displaying errors', () => {
			it('should display an error if the password is not provided with appropriate value on blur', async () => {
				...
				expect(
					screen.getByTestId('main-button').props.accessibilityState
						.disabled
				).toBe(true);
			});
