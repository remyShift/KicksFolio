		...
		slides: [
			{
				...
				description: i18n.t('changelog.feature1.description'),
				icon: 'sparkles',
				image: require('@/assets/images/changelogs/1.gif'),
			},
			{
				id: 'feature-2',
				title: i18n.t('changelog.feature2.title'),
			...
			{
				id: 'feature-3',
				title: i18n.t('changelog.feature3.title'),
			...
			{
				id: 'feature-4',
				title: i18n.t('changelog.feature4.title'),
			...
			{
				id: 'feature-5',
				title: i18n.t('changelog.feature5.title'),
			...
			{
				id: 'feature-6',
				title: i18n.t('changelog.feature6.title'),
